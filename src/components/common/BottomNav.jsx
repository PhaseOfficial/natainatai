...
const BottomNav = () => {
  return (
    <nav className="fixed bottom-0 left-0 w-full z-50 flex justify-around items-center h-20 px-2 pb-safe bg-[#F9F9F9] border-t-4 border-[#1B1B1B]">
      ...
      <Link to="/collection" className="flex flex-col items-center justify-center bg-[#124A17] text-[#F9F9F9] rounded-none px-6 py-2 scale-110 -rotate-2 active:translate-y-1 transition-transform">
